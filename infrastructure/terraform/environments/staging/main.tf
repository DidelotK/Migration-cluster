terraform {
  ...
  backend "s3" {
    # Configuration loaded from backend-configs/staging.hcl
  }
}
...
resource "local_file" "ansible_inventory" {
  ...
  filename = "${path.module}/../../ansible/inventories/staging.ini"
...
resource "local_file" "ansible_vars" {
  ...
  filename = "${path.module}/../../ansible/group_vars/k3s_servers_staging.yml"
...
resource "local_file" "ssh_script" {
  ...
  filename        = "${path.module}/../../scripts/connect-staging.sh"
